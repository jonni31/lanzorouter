<div align="center">
  <img src="../images/zevairouter.png?1" alt="Панель управления ZevaiRouter" width="800"/>
...
URL по умолчанию:
- Панель управления: `http://localhost:1997/dashboard`
- OpenAI-совместимый API: `http://localhost:1997/v1`
...
- Установите `PORT=1997` и `NEXT_PUBLIC_BASE_URL=http://localhost:1997`
