...
Claude Code/Codex/Gemini CLI/OpenClaw/Cursor/Clineの設定:
  エンドポイント: http://localhost:1997/v1
  APIキー: [ダッシュボードからコピー]
...
デフォルトURL：
- ダッシュボード: `http://localhost:1997/dashboard`
- OpenAI互換API: `http://localhost:1997/v1`
...
**ダッシュボードが違うポートで開く**
- `PORT=1997` と `NEXT_PUBLIC_BASE_URL=http://localhost:1997` を設定
