...
<div align="center">
  <img src="../images/zevairouter.png?1" alt="Bảng điều khiển ZevaiRouter" width="800"/>
...
URL mặc định:
- Bảng điều khiển: `http://localhost:1997/dashboard`
- API tương thích OpenAI: `http://localhost:1997/v1`
...
- Đặt `PORT=1997` và `NEXT_PUBLIC_BASE_URL=http://localhost:1997`
