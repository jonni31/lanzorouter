...
const navItems = [
  ...
  { href: "/dashboard/mitm", label: "MITM", icon: "vpn_lock" },
        ...
        <div className="px-6 py-4 flex flex-col gap-2">
          <Link href="/dashboard" className="flex items-center gap-3">
            <div className="flex items-center justify-center size-9 rounded-[10px] bg-gradient-to-br from-brand-500 to-brand-700 shadow-[var(--shadow-warm)] overflow-hidden">
              <img src="/lanzo-logo.png" alt="Lanzo Router" className="w-full h-full object-contain p-0.5" />
            </div>
  ...
  return (
    <div className="w-full max-w-lg rounded-xl bg-neutral-900/95 border border-white/10 p-6 text-white">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          <h2 className="text-lg font-semibold">Update Lanzo Router{latestVersion ? ` to v${latestVersion}` : ""}</h2>
