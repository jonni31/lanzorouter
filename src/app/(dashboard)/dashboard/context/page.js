        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div className="min-w-0">
            ...
            <p className="text-xs text-text-muted mt-1 max-w-xl">
              Prepend your own context files (soul.md, agent.md, rules…) to the system prompt of every chat request routed through LanzoRouter. Enabled files are injected in order, across all providers.
            </p>
          </div>
